...
void dac_init(void) {
    ...
    gpio_set_pin_output(CAPSENSE_DAC_NCS);
    gpio_set_pin_output(CAPSENSE_DAC_SCK);
    gpio_set_pin_output(CAPSENSE_DAC_SDI);
    gpio_write_pin(CAPSENSE_DAC_NCS, 1);
...
void dac_init(void) {
    gpio_set_pin_output(CAPSENSE_DAC_SCLK);
    gpio_set_pin_output(CAPSENSE_DAC_DIN);
    gpio_set_pin_output(CAPSENSE_DAC_SYNC_N);
...
void shift_init(void) {
    gpio_set_pin_output(CAPSENSE_SHIFT_DIN);
    gpio_set_pin_output(CAPSENSE_SHIFT_OE);
    gpio_set_pin_output(CAPSENSE_SHIFT_STCP);
    gpio_set_pin_output(CAPSENSE_SHIFT_SHCP);
...
#    if defined(LED_NUM_LOCK_ACTIVE_LOW)
    gpio_write_pin(LED_NUM_LOCK_PIN, !num_lock);
#    else
    gpio_write_pin(LED_NUM_LOCK_PIN, num_lock);
#    endif
#endif
...
#    if defined(LED_CAPS_LOCK_ACTIVE_LOW)
    gpio_write_pin(LED_CAPS_LOCK_PIN, !caps_lock);
#    else
    gpio_write_pin(LED_CAPS_LOCK_PIN, caps_lock);
#    endif
#endif
...
#    if defined(LED_SCROLL_LOCK_ACTIVE_LOW)
    gpio_write_pin(LED_SCROLL_LOCK_PIN, !scroll_lock);
#    else
    gpio_write_pin(LED_SCROLL_LOCK_PIN, scroll_lock);
#    endif
#endif
...
#    if defined(LED_NON_BASE_LAYER_ACTIVE_LOW)
    gpio_write_pin(LED_NON_BASE_LAYER_PIN, !value);
#    else
    gpio_write_pin(LED_NON_BASE_LAYER_PIN, !!value);
#    endif
}
...
#endif
#if defined(LED_NON_BASE_LAYER_PIN)
    gpio_set_pin_output(LED_NON_BASE_LAYER_PIN);
    set_led_non_base_layer(0);
#endif
    set_leds(0, 0, 0);
